...
banExpiresIn: 60 _ 60 _ 24 \* 7, // Optional (if not provided, the ban will never expire)
});
...
admin({
impersonationSessionDuration: 60 _ 60 _ 24, // 1 day
});
...
admin({
defaultBanExpiresIn: 60 _ 60 _ 24, // 1 day
});
